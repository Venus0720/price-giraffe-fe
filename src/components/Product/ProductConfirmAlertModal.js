...
export default function ProductConfirmAlertModal({
  product = {},
  open = false,
  onClose = fnDefault,
  onConfirm = fnDefault
        ...
        >
          <div className="inline-block sm:min-w-560px w-full max-w-md mx-4 sm:mx-0 px-7 pt-60px pb-9 sm:px-8 sm:pt-8 sm:pb-11 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-20px">
            ...
            <div className="mt-22px sm:mt-4 text-center sm:text-left">
              <button
                className="inline-flex items-center justify-center px-16 sm:px-10 py-3.5 sm:py-2 sm:bg-white bg-secondary sm:text-primary text-white border sm:border-primary border-secondary font-bold text-13px sm:text-15px rounded-full"
                onClick={confirm}
              >
                Notify Me
              </button>
